...
\newcommand\evalbreak{\\\noindent{\small\emph{(\opt{CZ}{pokračování na další straně}\opt{EN}{continues on the next page})}}\\\hline}
...
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Informatický ústav Univerzity Karlovy}\opt{EN}{Computer Science Institute of Charles University}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Katedra aplikované matematiky}\opt{EN}{Department of Applied Mathematics}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Katedra distribuovaných a spolehlivých systémů}\opt{EN}{Department of Distributed and Dependable Systems}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Katedra softwarového inženýrství}\opt{EN}{Department of Software Engineering}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Katedra softwaru a výuky informatiky}\opt{EN}{Department of Software and Computer Science Education}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Katedra teoretické informatiky a matematické logiky}\opt{EN}{Department of Theoretical Computer Science and Mathematical Logic}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Středisko informatické sítě a laboratoří}\opt{EN}{Network and Labs Management Center}}
%\field{\opt{CZ}{Pracoviště}\opt{EN}{Department}}{\opt{CZ}{Ústav formální a aplikované lingvistiky}\opt{EN}{Institute of Formal and Applied Linguistics}}
