...
\opt{CZ}{
\field{Autor posudku}{! \hfill Vedoucí}
%\field{Autor posudku}{! \hfill Oponent}
\field{Pracoviště}{!}
...
\opt{EN}{
\field{Review author}{! \hfill Advisor}
%\field{Review author}{! \hfill Reviewer}
\field{Department}{!}
}
...
\grade{Obtížnost zadání}{!}{}
\grade{Splnění zadání}{!}{}
\grade{Rozsah práce}{!}{textová i implementační část, zohlednění náročnosti}
...
\grade{Assignment difficulty}{!}{}
\grade{Assignment fulfilled}{!}{}
\grade{Total size}{!}{text and code, overall workload}
...
\grade{Formální úprava}{!}{jazyková úroveň, typografická úroveň, citace}
\grade{Struktura textu}{!}{kontext, cíle, analýza, návrh, vyhodnocení, úroveň detailu}
\grade{Analýza}{!}{}
\grade{Vývojová dokumentace}{!}{}
\grade{Uživatelská dokumentace}{!}{}
...
\grade{Form}{!}{language, typography, references}
\grade{Structure}{!}{context, goals, analysis, design, evaluation, level of detail}
\grade{Problem analysis}{!}{}
\grade{Developer documentation}{!}{}
\grade{User documentation}{!}{}
...
\grade{Kvalita návrhu}{!}{architektura, struktury a algoritmy, použité technologie}
\grade{Kvalita zpracování}{!}{jmenné konvence, formátování, komentáře, testování}
\grade{Stabilita implementace}{!}{}
...
\grade{Design}{!}{architecture, algorithms, data structures, used technologies}
\grade{Implementation}{!}{naming conventions, formatting, comments, testing}
\grade{Stability}{!}{}
