...
% https://github.com/D-iii-S/bc-review-form
% 
...
\begin{spacing}{1.0}
\footnotesize \noindent \textit{%
Prosím vyplňte hodnocení křížkem u každého kritéria. Hodnocení OK označuje
práci, která kritérium vhodným způsobem splňuje. Hodnocení lepší a horší
označují splnění nad a pod rámec obvyklý pro bakalářskou práci, hodnocení
nevyhovuje označuje práci, která by neměla být obhájena. Hodnocení v případě
potřeby doplňte komentářem. Komentář prosím doplňte všude, kde je hodnocení
jiné než OK.
}
\end{spacing}
...
% Pouze pokud bude mit vase hodnoceni vice jak 2 stranky, ma smysl
% zapinat cislovani stranek.
\pagestyle{empty}
...
% -----------------------------
%
% Jednotliva hodnocení vyplnte jako cisla 1-4 v druhem argumentu makra
% \grade (misto znaku X). 1 oznacuje splneni kriteria nad urovni beznou
% pro bakalarske prace, 2 splneni na obvykle urovni, 3 splneni pod
% beznou urovni a 4 oznacuje zavazny nedostatek.
%
% Slovni komentar vyplnte vzdy, pokud je hodnoceni jine nez "obvykle"
% splneni (tj. sloupecek OK a zde cislo 2).
%
...
% Do tohoto mista (pred konec prostredi evaluation) vlozte pripadny
% slovni komentar.
\end{evaluation}
...
% -----------------------------
%
% Hodnoceni probiha stejnym zpusobem jako v Souhrnnem hodnoceni vyse.
%
...
% souboru. Po vybrani znamky jej smazte nebo zakomentujte.
%
% Druhy parametr makra (Ano/Ne) se tyka navrzeni teto prace na zvlastni
% oceneni.
%
\finalgrade{X}{X}
